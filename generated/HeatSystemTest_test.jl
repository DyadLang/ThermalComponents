...
@testset "Running test case1 for HeatSystemTest" begin
  using CSV, DataFrames, Plots

  @mtkbuild model = HeatSystemTest()
  u0 = []
  prob = ODEProblem(model, u0, (0, 10))
  sol = solve(prob, DefaultODEAlgorithm())
  @test SciMLBase.successful_retcode(sol)
  @test sol[model.mass.T][end] ≈ 9.999 atol=0.001
  @test sol[model.mass.dT][end] ≈ 0 atol=0.001
